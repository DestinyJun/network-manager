...
import {UsePageQueryWell} from '../../shared/global.service';
import {ReqService} from '../../shared/req.service';

@Component({
  selector: 'app-paging-well',
  templateUrl: './paging-well.component.html',
  styleUrls: ['./paging-well.component.css']
})
export class PagingWellComponent implements OnInit {
  @Input()
  public pageBody: UsePageQueryWell;
  @Output()
  public pageBodyChange: EventEmitter<UsePageQueryWell> = new EventEmitter;
  @Input()
  public num: number;
